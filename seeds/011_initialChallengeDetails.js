...
exports.seed = async function(knex) {
  ...
  await knex('challengedetails').insert([
    ...
    {id: 7, section_id: 3, user_id: 2, detail_text: 'increase green veggies'},
    {id: 8, section_id: 3, user_id: 2, detail_text: 'aerobic cardio after workouts'},
    {id: 9, section_id: 3, user_id: 2, detail_text: 'substitute whole grains to minimize blood sugar spikes'},
  ]);
};
