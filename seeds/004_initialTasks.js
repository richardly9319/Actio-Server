...
exports.seed = async function(knex) {
  ...
  const tasks = [
    ...
    {id: 13, user_id: 2, taskgroup_id: 2, task_name: 'Allow users to right-click to open up menu items', priority_level: 4, active_state: true, reoccurance: 0, start_date: '2023-08-29', due_date: '2023-09-09'},
